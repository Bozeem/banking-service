package com.bozeemcoder.accountservice.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, BalanceEvent> balanceEventConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(BalanceEvent.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, BalanceEvent> balanceKafkaListenerContainerFactory() {
